...
const contractAddress = process.env.GATEWAY_CONTRACT;
const privateKey = Buffer.from(process.env.CALLER_PRIVATE_KEY ?? "", "hex");
const defaultAccount = process.env.CALLER_PUBLIC_ADDRESS ?? "";
